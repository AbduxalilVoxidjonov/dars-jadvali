...
/// </summary>
/// <remarks>
/// <b>PUBLIC</b> — ilgari <c>internal</c> edi va shu sababli Desktop
/// (<c>TimetableBoard.Evaluate</c>) qoidani o'zida takrorlashga majbur bo'lgan edi.
/// Endi prezentatsiya qatlami ham shu yagona manbaga tayanadi.
/// </remarks>
public static class LessonAvailabilityRules
{
    ...
    public static bool Covers(TeacherAvailability item, TimeSpan start, TimeSpan end)
    {
    ...
    public static TeacherAvailability? FindBlocking(
    ...
    public static List<TeacherAvailability> WhiteList(IEnumerable<TeacherAvailability> dayItems)
    {
        ArgumentNullException.ThrowIfNull(dayItems);
    ...
    /// </summary>
    public static bool IsAllowed(IEnumerable<TeacherAvailability> dayItems, TimeSpan start, TimeSpan end)
    {
        ArgumentNullException.ThrowIfNull(dayItems);
